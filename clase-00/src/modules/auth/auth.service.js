...
class AuthService {
  async registerUser(user) {
    ...
    if(findUser) throw new Error("El usuario ya existe con ese email");
  ...
  async login(email, password){
      ...
      if(!findUser || !isValidPassword(findUser, password)) throw new Error("El mail o password no válido");
